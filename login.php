            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="signin-form">
              ...
              <div class="form-group d-md-flex">
                ...
                <div class="w-50 text-md-right">
                  <a href="register.php" style="color: #fff">No Acccount ?</a>
                </div>
              </div>
            </form>
...
if(isset($_POST["submit"])) {
    ...
    // Ở đây bạn có thể thêm mã xác thực người dùng, ví dụ: kiểm tra tên người dùng và mật khẩu trong cơ sở dữ liệu

    // Sau khi xác thực, bạn có thể thực hiện các hành động như chuyển hướng người dùng đến trang chính sau khi đăng nhập thành công
}
?>
